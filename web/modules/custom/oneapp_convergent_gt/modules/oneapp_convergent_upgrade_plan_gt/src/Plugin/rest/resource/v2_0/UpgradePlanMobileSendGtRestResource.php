 ...
 *   block_id = "oneapp_convergent_upgrade_plan_mobile_v2_0_upgrade_block",
 *   id = "oneapp_convergent_upgrade_plan_mobile_send_v2_0_rest_resource",
 *   label = @Translation("Oneapp Convergent Upgrade Plan Mobile Send Gt v2_0"),
 *   uri_paths = {
 *     "canonical" = "/api/v2.0/mobile/plans/{idType}/{id}/currentplan",
 *   }
 * )
 */
class UpgradePlanMobileSendGtRestResource extends ResourceBase {

  /**
   * @var \Drupal\oneapp_convergent_upgrade_plan_gt\Services\v2_0\UpgradePlanMobileSendGtRestLogic
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->planSendRestLogic = $container->get('oneapp_convergent_upgrade_plan.v2_0.plan_mobile_send_rest_logic');
  ...
  public function put($idType, $id, Request $request) {
    ...
    try {
      ...
      $response_data = $this->planSendRestLogic->updateCurrentPlanMobile($id, $data, $idType);
    }
    catch (\Exception $e) {
