...
class VisitRescheduleGtBlock extends VisitRescheduleBlock {
  ...
  public function defaultConfiguration() {
    ...
    $this->others = [
      ...
      'confReschedule' => [
        'title' => $this->t("Formatos, mensajes y rango de días para enviar al formulario de reagendamiento"),
        'show' => 1,
    ...
    foreach ($others as $id => $entity) {
      ...
      if (isset($entity['labelForm'])) {
        $form['others'][$id]['labelForm'] = [
          '#title' => t('Título del label fecha'),
          '#type' => 'textfield',
      ...
      if (isset($entity['labelFormJor'])) {
        $form['others'][$id]['labelFormJor'] = [
          '#title' => t('Título del label del jornada'),
          '#type' => 'textfield',
      ...
      if (isset($entity['journaly'])) {
        $form['others'][$id]['journaly'] = [
          '#title' => t('Límite de jornadas por fecha'),
          '#type' => 'select',
          '#options' => $journal,
